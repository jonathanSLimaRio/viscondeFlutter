...
const UX_EVENT_NAME_MAP = {
  ...
  game_home_opened: "GAME_HOME_OPENED",
  adventure_resume_clicked: "ADVENTURE_RESUME_CLICKED",
  avatar_editor_opened: "AVATAR_EDITOR_OPENED",
  ...
  vault_story_opened: "VAULT_STORY_OPENED",
  vault_story_open_failed: "VAULT_STORY_OPEN_FAILED",
  vault_collection_actions_opened: "VAULT_COLLECTION_ACTIONS_OPENED",
...
const PARAM_ALLOWLIST: Record<keyof typeof UX_EVENT_NAME_MAP, readonly string[]> = {
  ...
  game_home_opened: ["source", "story_id", "child_id", "state", "status"],
  adventure_resume_clicked: ["source", "story_id", "child_id", "status", "action"],
  avatar_editor_opened: ["source", "target", "child_id"],
  avatar_saved: [
    "source",
    "target",
    "child_id",
  ...
  content_fallback_used: ["source", "flow", "story_id", "idea_source", "safety_adjusted"],
  ...
  vault_story_opened: ["source", "collection_id", "outcome"],
  vault_story_open_failed: ["source", "collection_id", "code", "message"],
  vault_collection_actions_opened: ["source", "collection_id"],
